...
public class Warehouse {
    ...
    private void fixHeap(int id) {
        ...
        //last index is being used as an argument
        //for swim to put it in right place
        //getSize() grabs the last index of the array
    }
    ...
    public void restockProduct(int id, int amount) {
        ...
        {
            if(id == sectors[index].get(i).getId())
            {
    ...
    public void purchaseProduct(int id, int day, int amount) {
        ...
        for(int i=1; i<=sectors[index].getSize(); i++)
        {
            if(id == sectors[index].get(i).getId() && amount <= sectors[index].get(i).getStock())
            {
